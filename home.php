   ...
   <div class="swiper-wrapper">
      ...
      <div class="swiper-slide slide">
         ...
         <div class="content">
            ...
            <h3>latest organic oil products</h3>
      ...
      <div class="swiper-slide slide">
         ...
         <div class="content">
            <span>upto 50% off</span>
            <h3>latest skincare products</h3>
            <a href="shop.php" class="btn">shop now</a>
         </div>
      </div>
...
<section class="category">
   ...
   <a href="category.php?category=Essential oil" class="swiper-slide slide">
      <img src="images/icon-11.png" alt="">
      <h3>Essential Oils</h3>
   </a>

   <a href="category.php?category=Herbs" class="swiper-slide slide">
      <img src="images/icon-12.png" alt="">
      <h3>Herbs</h3>
   </a>

   <a href="category.php?category=Perfumes" class="swiper-slide slide">
